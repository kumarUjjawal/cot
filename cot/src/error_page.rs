...
#[derive(Debug)]
pub(super) struct CotDiagnostics {
    router: Arc<Router>,
...
impl ErrorPageTemplateBuilder {
    ...
    fn diagnostics(&mut self, diagnostics: CotDiagnostics) -> &mut Self {
...
fn build_not_found_response(diagnostics: CotDiagnostics) -> Result<String> {
...
fn build_error_response(error: Error, diagnostics: CotDiagnostics) -> Result<String> {
